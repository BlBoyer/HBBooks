export default function About({capsule})
{
    ...
    return (
        <div>
            ...
            <hr />
            <div className="row mx-2 justify-content-center main text">
                <div className="col-5">
                    <p className="indent">
                    ...
                    <ol>
                        <li>Iryna Zimba. You translated my book into 3 languages via your linguistic skills. You are incredible. Hebrew, Russian and Ukrainian! You also arranged for the Chinese translator and German translator to come on board. Thank you so much!</li>
                        <li>Nataliya Kirienko. You translated my book into Chinese! I am impressed by your skill!</li>
                        <li>Aleksandra Ermakova. You translated my book into German! Thank you for doing this for me!</li>
                        <li>Auxiliadora del Socorro Lopez Artola. You translated my book into Spanish! I am grateful for this!</li>
                    </ol>
                    <p>
