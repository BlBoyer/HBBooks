      ...
      <header className='main'>
        <nav className='navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-bottom box-shadow mb-3'>
          <div className='container-fluid'>
            ...
            <div className='col-1 collapsable'>
              <hr align='center' />
            </div>
            <div className='navbar-collapse fit collapse d-sm-inline-flex justify-content-between border border-1'>
              <ul className='navbar-nav fit flex-grow-1'>
                <li className='nav-item'>
                  <a id='Welcome' className='nav-link' href={`${process.env.PUBLIC_URL}/#Welcome`}>
                    HOME
                  </a>
                </li>
                <li className='nav-item'>
                  <a id='Books' className='nav-link' href={`${process.env.PUBLIC_URL}/#Books`}>
                    BOOKS
                  </a>
                </li>
                <li className='nav-item'>
                  <a id='About' className='nav-link' href={`${process.env.PUBLIC_URL}/#About`}>
                    ABOUT
                  </a>
                </li>
              </ul>
            </div>
            <div className='col collapsable'>
              <div>
                <hr align='center' />
              </div>
            </div>
